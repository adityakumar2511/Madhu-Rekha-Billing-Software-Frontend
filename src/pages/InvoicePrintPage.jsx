...
export default function InvoicePrintPage() {
  ...
  const isPdf = search.get("pdf") === "1"; // ✅ when Playwright prints
  ...
  const outerClass = isPdf
    ? // PDF mode: white bg, no grey frame
      "bg-white flex justify-center"
    : // Normal browser view
      "min-h-screen bg-slate-300 flex items-center justify-center print:bg-white";
        ...
        <div className="p-6">
          ...
          <div className="text-[10px] mb-2">
            ...
            <div className="flex justify-between mt-1">
              ...
              {bill.age != null && <div>Age: {bill.age} Years</div>}
            </div>
